...
begin
  if (FParams.Count >= 0) and (Fparams[0].resType is TLapeType_Type) then
    Result := TLapeType_Type(FParams[0].resType).TType
  else
...
begin
  ...
  begin
    ...
    try
      ...
      addParam(TLapeTree_Integer.Create(1, Self.FParams[0]));
