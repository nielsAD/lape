...
uses
  ...
  StdCtrls, ExtCtrls, SynEdit, SynHighlighterPas, lptypes, lpcompiler;
...
type
  ...
  private
    procedure WriteHint(Sender: TLapeCompiler; Msg: lpString);
  end; 
...
uses
  lpparser, lpvartypes, lputils, lpeval, lpinterpreter, lpdisassembler, {_lpgenerateevalfunctions,}
...
procedure TForm1.WriteHint(Sender: TLapeCompiler; Msg: lpString);
begin
  m.Append(Msg);
end;
