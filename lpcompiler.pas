...
begin
  ...
  try
    ...
    LeftVar := _ResVar.New(FStackInfo.addVar(lptVar, AParams[0], 'Left'));
    RightVar := _ResVar.New(FStackInfo.addVar(lptVar, AParams[1], 'Right'));
    ResultVar := _ResVar.New(FStackInfo.addVar(lptVar, AResult, 'Result'));
